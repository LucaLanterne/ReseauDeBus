...
{
    public string id_infoTrafic { get; set; }
    ...
    public InfoTrafic(string idInfoTrafic, int sensCirculationInfoTrafic, Planifiable emplacementBusInfoTrafic, Bus busInfoTrafic, Ligne ligneInfoTrafic, DateTime horaireDepartInfoTrafic, Simulation simulationInfoTrafic)
    {
        id_infoTrafic = idInfoTrafic;
        sensCirculation_infoTrafic = sensCirculationInfoTrafic;
        emplacementBus_infoTrafic = emplacementBusInfoTrafic;
